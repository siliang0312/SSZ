...
To update the database use this command from the Web project folder (replace `SSZ` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../SSZ.Infrastructure/SSZ.Infrastructure.csproj -s SSZ.Web.csproj
```
